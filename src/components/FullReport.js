  ...
  return (
    <div className={styles.fullReport}>
      ...
      <b className={styles.analysisTheBlue}>
        Analysis: The blue bar is correlated with the plafond of the user´s
        contract, based on the “Variation Based on Contract” graphic, this is a
        specific month version.
      </b>
      <b className={styles.analysisTheAccumulated}>
        Analysis: The accumulated energy used since the first day of the month
        until the last day of the month, if the value is above 1000 kWh the user
        needs to be careful with the number of charges and how long the plug is
        on.
      </b>
      <b className={styles.analysisIfTheContainer}>
        <p className={styles.analysisIfThe}>
          Analysis: If the line is below the 100% mark means the user spent
          below the contract´s plafond, and above the 100% mark means the user
          spent more then the contract plafond.
        </p>
      </b>
      <b className={styles.analysisIfTheContainer1}>
        <p className={styles.analysisIfThe}>
          Analysis: If the socket is consuming 0 KwH and has not been switched
          on, the value shown in the line graph represents what the socket has
      ...
      <div className={styles.power}>
        ...
        <div className={styles.nbChartsGauge5Wrapper}>
          <div className={styles.gauge2Icon}>
            <img className={styles.gauge2Icon} alt="" src="/gauge-2.svg" />
            <img
            ...
            <img className={styles.point3Icon} alt="" src="/point-3.svg" />
          </div>
        </div>
      </div>
      ...
      >
        ...
        <img className={styles.backgroundIcon1} alt="" src="/background1.svg" />
        ...
        <b className={styles.variationBasedOn}>Variation based on Contract</b>
