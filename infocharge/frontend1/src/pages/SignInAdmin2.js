...
import styles from "./SignInAdmin2.module.css";
...
const SignInAdmin2 = () => {
  ...
  return (
    <div className={styles.signInAdmin2}>
      <div className={styles.content}>
        <div className={styles.logo}>
          <img className={styles.logo1Icon} alt="" src="/logo-11@2x.png" />
        </div>
        <div className={styles.header}>
          <b className={styles.tittle}>Sign In to your Account</b>
